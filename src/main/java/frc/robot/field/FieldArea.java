...
public class FieldArea {
    ...
    public FieldArea(double x1, double y1, double x2, double y2){
        this(new Translation2d (x1,y1), new Translation2d(x2, y2));
    }

    public FieldArea(Translation2d bottomLeft, double x2, double y2){
        this(bottomLeft, new Translation2d(x2, y2));
    }

    public FieldArea(Translation2d bottomLeft, Translation2d topRight) {
