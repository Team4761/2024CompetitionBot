...
public class LedSubsystem extends SubsystemBase implements LedSubsystemInterface {
    ...
    // Singleton pattern
    // --------------------------------------------------
    public static LedSubsystemInterface singleton = null;

    public static LedSubsystemInterface getSingleton() {
        if (singleton == null) {
            try {
                singleton = new LedSubsystem();
            } catch (Throwable t) {
                singleton = new LedSubsystemMock();
            }
        }
        return singleton;
    }
